...
import ilgulee.com.weatherapi.weather.Day;
import ilgulee.com.weatherapi.weather.Forecast;
import ilgulee.com.weatherapi.weather.Hour;
import okhttp3.Call;
...
//    private Current mCurrent;
    ...
    private Day[] getDailyForecast(String jsonData) throws JSONException {
        ...
        for(int i=0;i<data.length();i++){
            ...
            day.setTemperatureHigh(jsonDays.getDouble("temperatureHigh"));
            day.setTemperatureLow(jsonDays.getDouble("temperatureLow"));
